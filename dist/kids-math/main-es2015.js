...
let CardHoleBoardComponent = class CardHoleBoardComponent {
    constructor() {
        this.boardNumbers = [
            { value: 1, checked: false },
            { value: 2, checked: false },
        ...
        this._getNewBoardNumbers = () => {
            return this.boardNumbers.slice(-10).map(({ value }) => {
                return { value: value + 10, checked: false };
            });
        };
        this.checkFinish = ({ number: { value, checked }, previousContainer }) => {
            ...
            if (isFinish) {
                ...
                if (this.boardNumbers.length > 10)
                    this.boardNumbers.splice(0, 10);
...
let CardHoleComponent = class CardHoleComponent {
    constructor() {
        ...
        this.validateDragCondition = e => {
            const { value } = this.holeNumber;
            return (this.hole.length >= 1 ||
